...
# ============
#
# This is a test suite for NICE9 compilers.
#
...
class NICE9Test(unittest.TestCase):
...
class FakeLoader(object):
    def loadTestsFromModule(self, *args, **kwargs):
        import os
        return unittest.TestSuite(NICE9Test('tests/'+fn) for fn in os.listdir('tests') if fn.endswith('.9') and not fn.startswith('.'))
